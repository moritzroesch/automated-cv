...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/moritzroesch/automated-cv/tree/main/CV_en/output/roes_cv_en.pdf)")
}
```
...
The source code is available [on github.com/nstrayer/cv](https://github.com/moritzroesch/automated-cv).
